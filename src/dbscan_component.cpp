# HDBSCAN
#include "dbscan.h"
#include "dbscan_ros2/dbscan.hpp"


#define MINIMUM_POINTS 4     // minimum number of cluster
#define EPSILON (0.75*0.75) 

DBSCAN::DBSCAN() : Node("pointcloud_cluster_node")
    {
    declare_parameter("m_minPoints",MINIMUM_POINTS);
    declare_parameter("m_epsilon",(0.75*0.75));
    get_parameter("m_minPoints"m_minPoints);
    get_parameter("m_epsilon",m_epsilon); 
...
void DBSCAN::pointCloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
